...
- [Tek 3](#tek-3)
    ...
    - [Functional tests](#functional-tests-3)
    - [Projects](#projects-2)
        - [AREA](#area)
        - [Glados](#glados)
        - [R-Type](#r-type)
...
- NeoVim - A free and open-source IDE.
    - [ECSLS](https://github.com/Sigmapitech/ecsls) - Coding Style as Language Server (Live)
    - [EHCSLS](https://github.com/Sigmapitech/ehcsls) - Haskell Coding Style as Language Server (Live)
...
#### Pool
- [Haskell pool](https://github.com/mpellouin/haskell-pool) (Promo 2025 - Lyon) - Haskell pool by Maxence Pellouin.
